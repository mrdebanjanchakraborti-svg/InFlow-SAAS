    ...
    return (
        <div className="bg-base-200 rounded-lg shadow-xl overflow-hidden transform hover:-translate-y-2 transition-transform duration-300">
            <div className="p-6">
                ...
                <button className="w-full mt-8 bg-brand-primary text-white font-bold py-3 rounded-lg hover:bg-brand-secondary transition-colors">
                    Subscribe Now
                </button>
            </div>
        </div>
        ...
        <div className="min-h-screen bg-base-100 p-4 md:p-8">
            <div className="max-w-7xl mx-auto">
                 <nav className="flex justify-between items-center py-4">
                    <img src={LOGO_BASE64} alt="Inflow logo" className="h-10" />
